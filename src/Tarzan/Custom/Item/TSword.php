...
class TSword extends Sword
{
    private $maxdura = 0;
    private $attackdamage = 0;

    public function __construct(int $id, int $meta, string $name, int $tier, int $maxdura,int $attackdamage)
    {
    ...
    {
        return $this->attackdamage; // TODO: Change the autogenerated stub
    }
